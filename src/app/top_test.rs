...
fn top_all_tasks_categorized_the_same() {
    ...
    fix.test("todo top")
        .validate()
        .printed_exact_task(&PrintableTask::new("d", 4, TaskStatus::Blocked))
        .end();
}
...
fn top_multiple_categories() {
    ...
    fix.test("todo top")
        .validate()
        .printed_exact_task(&PrintableTask::new("g", 7, TaskStatus::Blocked))
        .printed_exact_task(&PrintableTask::new("h", 8, TaskStatus::Blocked))
        .end();
}
...
fn top_deep_category() {
    ...
    fix.test("todo top")
        .validate()
        .printed_exact_task(&PrintableTask::new("c", 5, TaskStatus::Blocked))
        .printed_exact_task(&PrintableTask::new("f", 6, TaskStatus::Blocked))
        .end();
}
...
fn top_does_not_show_complete_tasks_by_default() {
    ...
    fix.test("todo top")
        ...
        .printed_exact_task(&PrintableTask::new("c", 2, TaskStatus::Incomplete))
        .end();
}
...
fn top_show_complete_tasks_with_option() {
    ...
    fix.test("todo top -d")
        .validate()
        .printed_exact_task(&PrintableTask::new("a", 0, TaskStatus::Complete))
        .printed_exact_task(&PrintableTask::new("b", 1, TaskStatus::Incomplete))
        .printed_exact_task(&PrintableTask::new("c", 2, TaskStatus::Incomplete))
        .end();
}
...
fn top_show_only_top_level_complete_tasks() {
    ...
    fix.test("todo top -d")
        .validate()
        .printed_exact_task(&PrintableTask::new("c", -3, TaskStatus::Complete))
        .printed_exact_task(&PrintableTask::new("f", 0, TaskStatus::Complete))
        .end();
}
...
fn top_intersection_of_categories() {
    ...
    fix.test("todo top x y")
        .validate()
        .printed_exact_task(&PrintableTask::new("c", 3, TaskStatus::Incomplete))
        .printed_exact_task(&PrintableTask::new("d", 4, TaskStatus::Incomplete))
        .end();
}
